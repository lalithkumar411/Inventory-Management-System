...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="container container1">
      <form action="../config/database.php" class="form-signin" method="post">
        <img class="mb-4" src="../public/favicon_io/favicon.ico" alt="" width="72" height="72">
        <h1 class="h3 mb-3 font-weight-normal">Admin sign in</h1>
        <br>
        <input type="email" name="admin-mail" id="inputEmail" class="form-control pp" placeholder="Username" required="true">
        <input type="password" name="admin-pass" id="inputPassword" class="form-control pp" placeholder="Password" required="true">
        <br>
        ...
        <button name="admin-log-sub" id="sub" class="btn btn-lg btn-primary btn-block" type="submit">Sign in</button>
      </form>
    </div>
  </body>
